...
export default function Slider() {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get('https://newmail-2.onrender.com/get/slider');
    ...
    formDataToSend.append("sliderimg", formData.propertyImg);
        try {
            if (isEdit) {
                ...
                await axios.put(`https://newmail-2.onrender.com${formData.id}`, formDataToSend);
            } else {

                await axios.post('https://newmail-2.onrender.com/slider/add', formDataToSend);
    ...
    const handleDelete = async (id) => {
        try {
            await axios.delete(`https://newmail-2.onrender.com/slider/delete/${id}`);
            fetchData();
        } catch (error) {
